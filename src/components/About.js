...
import banner from   '../assets/About_04.jpg'

const About = () => {
  return (
    <> 
    <div className=" ">
    <div className="w-full  lg:ml-auto h-48  sm:h-96">
    <img class="w-full lg:h-80" src={banner} alt="" />
    </div>
  </div>
  
  <div className='px-4 py-11 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-6'>
    
       <div class="p-5">
              <h5 class=" text-center mb-11  text-5xl font-bold tracking-tight text-gray-900 dark:text-white">
              Our Story
              </h5>
          ...
          <div className='space-y-8'>
            <div>
              ...
              <p className='text-gray-700'>
              Praesent varius ultrices massa at faucibus. Aenean dignissim, orci sed faucibus pharetra, dui mi dignissim tortor, sit amet condimentum mi ligula sit amet augue.
              </p>
            </div>
      ...
      <div className='max-w-xl sm:mx-auto lg:max-w-2xl mt-7'>
