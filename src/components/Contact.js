...
const Contact = () => {
  ...
  <>
    <h2 className="text-5xl text-teal-400 my-2 text-center">Contact Us</h2>
     <div class="container my-8 px-6 mx-auto bg-cyan-600 shadow-sm border border-cyan-600 text-white">
  ...
  <div class="container text-gray-800 px-4 md:px-12">
    <div class="block rounded-lg shadow-lg py-10 md:py-12 px-4 md:px-6"
      ...
      <div className="grid md:grid-cols-2  lg:grid-cols-3 gap-x-6 mb-12">
        <div className="mb-12 lg:mb-0 text-center mx-auto text-white">
          ...
          <h6 className="font-medium text-white">Bangladesh Office</h6>
          <p className="text-white">proReader</p>
          <p>Block # C, House # 2, 1 রোড-2,Mohammapur Dhaka 1207</p>
          
        </div>
        <div class="mb-6 md:mb-0 text-center mx-auto text-white">
